...
public class TypeProductFrame extends javax.swing.JFrame {
     ...
     */
    public TypeProductFrame() throws SQLException, ClassNotFoundException {
        initComponents();
    ...
    private void showLoaiSP() throws SQLException, ClassNotFoundException{
    ...
    private void btnLuuActionPerformed(java.awt.event.ActionEvent evt) throws SQLException, ClassNotFoundException {                                       
    	String maLoaiSP = txtMaLoaiSP.getText();
    	String tenLoaiSP = txtTenLoaiSP.getText();
