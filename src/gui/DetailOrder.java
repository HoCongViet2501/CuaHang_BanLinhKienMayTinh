...
public class DetailOrder extends javax.swing.JFrame {
	...
	private void showData(String ma) throws SQLException, ClassNotFoundException {
    	...
    	valueMucgiam.setText(listSP.get(0).get(3));
    	tableModel.setRowCount(0);
    	for(List<String> l: listSP) {
    		tableModel.addRow(new Object[] {l.get(0),l.get(1),l.get(2),Double.parseDouble(l.get(1))*Double.parseDouble(l.get(2))-Double.parseDouble(l.get(3))});
    	}
    }
    /**
    ...
    private void initComponents() {
        ...
        valueMucgiam = new javax.swing.JLabel();
        ...
        labelTongTien.setText("Thành tiền: ");
        ...
        valueMucgiam.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        valueMucgiam.setText("value_TienGiam");

        labelMucGiam.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        labelMucGiam.setText("Mức giảm giá: ");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
					try {
						new DetailOrder(null).setVisible(true);
    ...
    private javax.swing.JLabel valueMucgiam;
